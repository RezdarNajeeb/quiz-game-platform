    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 flex items-center justify-center p-4" dir={settings.language === 'ckb' ? 'rtl' : 'ltr'}>
      <div className="bg-white rounded-2xl shadow-2xl p-12 text-center max-w-md w-full">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">{t('roundComplete')}</h1>
          <p className="text-gray-600">{t('allUsersCompleted')}</p>
        </div>
        ...
        <button
          onClick={onResetGame}
          className="flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-200 mx-auto shadow-lg"
        >
          <RotateCcw size={24} />
