      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-lg">
          ...
          <div className="border-b border-gray-200 p-6">
            <h1 className="text-3xl font-bold text-gray-800">{t('quizGameAdminPanel')}</h1>
          </div>
          ...
          <div className="p-6">
            {activeTab === 'users' && (
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium mb-3">{t('addNewUser')}</h3>
            ...
            {activeTab === 'questions' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h2 className="text-2xl font-semibold">{t('questionManagement')}</h2>
                  <button
                    onClick={saveData}
                    disabled={saveStatus === 'saving'}
                    className="bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white px-4 py-2 rounded-md flex items-center space-x-2 transition-colors"
                ...
                {/* Add Question */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium mb-3">{t('addNewQuestion')}</h3>
                  <div className="space-y-3">
                    <input
                      type="text"
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6 max-w-2xl">
                ...
                <button
                  onClick={saveData}
                  disabled={saveStatus === 'saving'}
                  className="bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white px-6 py-3 rounded-md flex items-center space-x-2 transition-colors"
                >
                  <Save size={20} />
            ...
            {activeTab === 'status' && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">{t('gameStatus')}</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-blue-800 mb-2">{t('totalUsers')}</h3>
                    <p className="text-3xl font-bold text-blue-600">{users.length}</p>
                  </div>
                  
                  <div className="bg-green-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-green-800 mb-2">{t('usersPlayed')}</h3>
                  ...
                  <div className="bg-purple-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-purple-800 mb-2">{t('questionsUsed')}</h3>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                  <h3 className="font-semibold text-red-800 mb-4">{t('resetGameRound')}</h3>
